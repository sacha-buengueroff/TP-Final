...
class ApiUsuarios {
    ...
    enviarMailConfirmacion = async email => {
        var mailOptions = {
            ...
            to: email,
            subject: 'HELLO KITCHEN// ¡Bienvenidx, te estabamos esperando!',
            ...
            <p style="color: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif; font-size: 18px; line-height: 125%; font-weight: 400; text-align: left;">Estamos muy felices de que te sumes a nuestra comunidad. Cada paladar es único y compartirlo genera momentos innolvidables. Sacáte el miedo a la cocina. ¡Te esperamos!</p>
